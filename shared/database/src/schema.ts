...
export const personalTransactionsTable = sqliteTable(
	...
	(personalTransactions) => [
		check(
			'typePersonalTransactions_check',
			sql`${personalTransactions.type} IN ('income', 'expense')`,
		),
	],
);
...
export const organizationTransactionsTable = sqliteTable(
	...
	(organizationTransactions) => [
		check(
			'typeOrganizationTransactions_check',
			sql`${organizationTransactions.type} IN ('income', 'expense')`,
		),
	],
);
